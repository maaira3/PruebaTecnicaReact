...
export default function PaginationCards({pagina, setPagina, maximo}) {
  ...
  return (
    <div className="container">
      <button disabled={pagina === 1 || pagina < 1} onClick={previousPage} className="button">
        <svg viewBox="0 0 20 27" fill="none" xmlns="http://www.w3.org/2000/svg" className="svg">
          <path
